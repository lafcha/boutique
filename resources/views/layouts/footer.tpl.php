...
<footer class="bg-primary py-2 container-fluid">
    <div class=" d-flex flex-md-row justify-content-md-between flex-column align-items-center">
        <div class="d-flex flex-column align-items-center text-center py-3 text-success w-50">
            ...
            <a class="text-success text-decoration-none" href="">Nos Viennoiseries</a>
            <a class="text-success text-decoration-none" href="">Nos Pâtisseries</a>
            <a class="text-success text-decoration-none" href="">Nos Snacks</a>
            <a class="text-success text-decoration-none" href="">Nos Boissons</a>
            <a href="http://boutique.local/?action=cart"><div class="cart-pill2"></div></a>
        </div>
        ...
        <div class="bg-success d-flex flex-column align-items-center text-center p-3 m-3 w-50">
            ...
            <a class="text-primary text-decoration-none" href="">email@email.fr</a>
        </div>
